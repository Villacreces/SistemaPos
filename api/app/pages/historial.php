...
<body>
            ...
            <div class="panel-filtros shadow-sm p-4 mb-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" id="filtro-cliente" class="form-control" placeholder="Nombre o cédula">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" id="filtro-factura" class="form-control" min="1" placeholder="Ej. 8">
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-3">
                    ...
                    <button type="button" class="btn btn-verde" id="btn-buscar">
                        Buscar
                    </button>
    ...
    <!-- Modal de detalles -->
    <div class="modal fade" id="modalDetalleVenta" tabindex="-1" aria-labelledby="tituloDetalleVenta"
        aria-hidden="true">
